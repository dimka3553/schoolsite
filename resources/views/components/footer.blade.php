<footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8">
                <span class="flex gap-x-4 text-blue-500 font-semibold text-3xl">
                    ...
                    {{ app()->make('tenant')->name }}
                </span>


                <p class="text-sm leading-6 text-gray-600">Making the world a better place through excellent school websites.</p>
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-sm font-semibold leading-6 text-gray-900">Our classes</h3>
                        <ul role="list" class="mt-6 space-y-4">
                            @foreach($classes as $class)
                                <li>
                                    <a href="{{-- route('class', $class) --}}" class="text-sm leading-6 text-gray-600 hover:text-gray-900">{{ $class->title . ' - ' . $class->age_group }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="mt-10 md:mt-0">
                        <h3 class="text-sm font-semibold leading-6 text-gray-900">Infopages</h3>
                        <ul role="list" class="mt-6 space-y-4">
                            @foreach($infopages as $infopage)
                                <li>
                                    <a href="{{-- route('class', $class) --}}" class="text-sm leading-6 text-gray-600 hover:text-gray-900">{{ $infopage->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
